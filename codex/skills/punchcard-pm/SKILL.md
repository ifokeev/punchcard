---
name: punchcard-pm
description: Turn intent into self-contained punchcard tasks on OpenAI Codex CLI. Decomposes a request into well-scoped briefs and files them via the `punch` CLI. Use in the planning session.
---
